...
// Props from backend (ProductResource)
const props = defineProps({
    product: Object,
});

// Initialize form with Inertia, prefill with existing product data
const form = useForm({
    _method: 'put',
...
// Image preview (show previous image if exists)
...
const submit = () => {
    form.post(
        route('admin.products.update', { product: props.product.id }),
        {
            preserveScroll: true,
            forceFormData: true,
            onSuccess: () => {
